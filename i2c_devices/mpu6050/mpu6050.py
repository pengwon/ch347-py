...
between a CH347 and a MPU-6050 Gyroscope / Accelerometer combo.

Released under the MIT License

Thanks for Martijn (martijn@mrtijn.nl) and contributers
...
class MPU6050:
    ...
    def __init__(self, address=0x68, driver=ch347.CH347()):
        self.address = address << 1
        self.driver = driver

        self.driver.open_device()
        # Wake up the MPU-6050 since it starts in sleep mode
        self.driver.stream_i2c([self.address, self.PWR_MGMT_1, 0x00], 0)
